...
// 2 nhóm bắt số ($1 cho dạng "Câu N", $2 cho dạng số trần "N.") — dùng để phát hiện nhảy số thứ tự
// câu hỏi trong file gốc (vd Câu 1, 2, 5 — thiếu câu 3, 4), xem validateExport.ts.
